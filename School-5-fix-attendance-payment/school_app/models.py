...
class StudentGroup(models.Model):
    ...
    balance = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal('0.00'), verbose_name="رصيد الطالب في الفوج")
        ...
        with transaction.atomic():
            ...
            if self.group and self.group.price_per_4_sessions and self.group.price_per_4_sessions > 0:
                ...
                for attendance in paid_attendances:
                    ...
                    try:
                        student_group = StudentGroup.objects.get(student=student, group=self.group)
